    ...
    <div class="container">
        <div class="terminal-nav">
            ...
            <nav class="terminal-menu">
                <ul>
                    <li><a href="add.php" class="menu-item active">Dodaj produkt</a></li>
            ...
            <form action="#" method="post">
                <fieldset>
                    ...
                    <div class="main-form">
                        <input type="text" name="product" id="" placeholder="Nazwa produktu" required>
                        <input type="number" name="quantity" id="" placeholder="Ilość" required>
                        <input type="number" name="price" id="" placeholder="Cena" required>
