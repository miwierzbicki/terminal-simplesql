        ...
        <div class="terminal-nav">
            ...
            <nav class="terminal-menu">
                <ul>
                    ...
                    <li><a href="remove.php" class="menu-item active">Usuń</a></li>
            ...
            <form action="#" method="post">
                <fieldset>
                    <legend>Usuń produkt po ID</legend>
                    <div class="main-form">
            ...
            <?php
                ...
                if(!$polaczenie) {
                    ...
                    $usun_produkt = "DELETE FROM produkty WHERE id=$id";
                    $wynik = mysqli_query($polaczenie, $usun_produkt);
            ?>
